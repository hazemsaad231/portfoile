    ...
    return (
        ...
        <div className="flex flex-col gap-10 sm:flex-col md:flex-row lg:flex-row xl:flex-row justify-around items-center px-4 py-40" id='about'style={{fontFamily:"serif"}} >
          ...
          <div data-aos="fade-left">
            ...
            <h1 className="bg-gradient-to-r from-indigo-700 to-gray-100 bg-clip-text text-transparent text-center text-2xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl tracking-[8px]">About Me</h1>
