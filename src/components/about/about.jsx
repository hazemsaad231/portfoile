    ...
    return (
        ...
        <div className="flex flex-col gap-10 sm:flex-col md:flex-row lg:flex-row xl:flex-row justify-around items-center h-full px-4 py-28" id='about'style={{fontFamily:"serif"}} >
          ...
          <div data-aos="fade-left">
            ...
            I've built online stores, control panels, and data management systems, and I'm interested in improving performance and user experience.Beyond coding,I enjoy collaborating with teams to bring ideas to life 
            andsolving complex challenges, and refining user interfaces for better engagement and functionality.
