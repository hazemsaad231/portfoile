            ...
            {currentProjects.length > slidesPerView && (
              <>
                <button
                  ...
                  className={`absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1 z-10 w-12 h-12 rounded-full bg-slate-800/90 backdrop-blur-sm border border-slate-700 flex items-center justify-center transition-all ${
                    currentSlide === 0
                ...
                <button
                  ...
                  className={`absolute right-0 top-1/2 -translate-y-1/2 translate-x-1 z-10 w-12 h-12 rounded-full bg-slate-800/90 backdrop-blur-sm border border-slate-700 flex items-center justify-center transition-all ${
